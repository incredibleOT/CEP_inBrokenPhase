...
void plotPotential_inBrokenPhase_helper::prepareParameterMaps( std::map< std::string, double > &paraD, std::map< std::string, int > &paraI, std::map< std::string, std::string > &paraS, std::map< std::string, bool > &paraIsSet )
{
...
bool plotPotential_inBrokenPhase_helper::loadParameterMapsFromFile( std::map< std::string, double > &paraD, std::map< std::string, int > &paraI, std::map< std::string, std::string > &paraS, std::map< std::string, bool > &paraIsSet, const std::string &fileName )
{
...
void plotPotential_inBrokenPhase_helper::streamSetParameterMaps( std::map< std::string, double > &paraD, std::map< std::string, int > &paraI, std::map< std::string, std::string > &paraS, std::map< std::string, bool > &paraIsSet, std::ostream &output, const std::string &prefix)
{
	for( std::map< std::string, double >::const_iterator iter=paraD.begin(); iter!=paraD.end(); ++iter )
	{
...
bool plotPotential_inBrokenPhase_helper::checkConsistencyOfParameters( std::map< std::string, double > &paraD, std::map< std::string, int > &paraI, std::map< std::string, std::string > &paraS, std::map< std::string, bool > &paraIsSet )
{
	//extend related
...
void plotPotential_inBrokenPhase_helper::fillSetWithRange( const double min, const double max, const double step, std::set< double > &toFill)
{
	toFill.clear();
...
std::string plotPotential_inBrokenPhase_helper::generate_outputFileName(const std::string &baseName, std::map< std::string, double > &paraD, std::map< std::string, int > &paraI, std::map< std::string, bool > &paraIsSet )
{
	...
	if( outputFileName.find("[yr]")!=std::string::npos )
	{
		...
		ss <<"yr_";
		ss.precision(7);
		ss <<paraD["yukawa_ratio"];
		outputFileName.replace(outputFileName.find("[yr]"),4, ss.str() );
	}
	if( outputFileName.find("[field]")!=std::string::npos )
	{
		std::ostringstream ss;
		ss <<"scan_";
		ss.precision(7);
		ss <<paraD["field_min"] <<"_" <<paraD["field_max"];
		outputFileName.replace(outputFileName.find("[field]"),7, ss.str() );
	}
